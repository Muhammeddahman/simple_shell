...
/**
 * _setEnvironmentVar - Initializes a new environment variable,
 *                      or modifies an existing one
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: Always 0
 */
int _setEnvironmentVar(info_t *info)
{
	if (info->argc != 3)
	{
...
/**
 * _unsetEnvironmentVar - Removes an environment variable
 * @info: Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: Always 0
 */
int _unsetEnvironmentVar(info_t *info)
{
	int i;
